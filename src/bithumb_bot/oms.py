...
def create_order(
    *,
    ...
    normalized_h74_entry_plan_id = str(h74_entry_plan_client_order_id or "").strip() or None
    ...
    if normalized_h74_contract_json and not normalized_h74_entry_plan_id:
        raise RuntimeError("h74_cycle_ownership_required_for_entry:h74_entry_plan_client_order_id")
    ...
    try:
        conn.execute(
            ...
            INSERT INTO orders(
                ...
                pair, strategy_name, strategy_instance_id, cycle_id, authority_hash,
                h74_entry_plan_client_order_id, h74_position_ownership_contract_hash, h74_position_ownership_contract,
                entry_decision_id, exit_decision_id, decision_reason, exit_rule_name,
