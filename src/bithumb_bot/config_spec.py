...
DECLARED_ENV_NAMES: tuple[str, ...] = (
    ...
    "BITHUMB_OPERATOR_DIRTY_RUNTIME_ACK",
    ...
    "BITHUMB_RUNTIME_GIT_DIFF_ARTIFACT_PATH",
    "BITHUMB_RUNTIME_GIT_DIFF_HASH",
    "BITHUMB_SOURCE_ARCHIVE_HASH",
...
def _category_for(name: str) -> str:
    if name in {"BITHUMB_BATCH_CHILD_WORKER_BUDGET", "BITHUMB_TOTAL_PROCESS_BUDGET"}:
        return "runtime"
