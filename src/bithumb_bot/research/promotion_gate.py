...
def build_candidate_profile(candidate: dict[str, Any]) -> dict[str, Any]:
    ...
    profile = {
        ...
        "final_holdout_reuse_key_hash_v1": candidate.get("final_holdout_reuse_key_hash_v1"),
        "final_holdout_reuse_key_hash": candidate.get("final_holdout_reuse_key_hash"),
        "final_holdout_reuse_key_schema_version": candidate.get("final_holdout_reuse_key_schema_version"),
        "final_holdout_reuse_key_hash_v2": candidate.get("final_holdout_reuse_key_hash_v2"),
    ...
    *,
    ...
    artifact = {
        ...
        **_manifest_policy_flags(candidate, report),
        ...
        "final_holdout_reuse_key_hash_v1": report.get("final_holdout_reuse_key_hash_v1"),
        "final_holdout_reuse_key_hash": report.get("final_holdout_reuse_key_hash"),
        "final_holdout_reuse_key_schema_version": report.get("final_holdout_reuse_key_schema_version"),
        "final_holdout_reuse_key_hash_v2": report.get("final_holdout_reuse_key_hash_v2"),
