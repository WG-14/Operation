...
def metrics_gate_policy_from_acceptance_gate(gate: Any) -> dict[str, object]:
    return {
        ...
        "min_expectancy_per_trade_krw": getattr(gate, "min_expectancy_per_trade_krw", None),
        "min_expectancy_per_trade_pct": getattr(gate, "min_expectancy_per_trade_pct", None),
...
def metrics_gate_policy_summary(policy: dict[str, Any] | None) -> dict[str, object] | None:
