...
def validate_profile_transition_evidence(
    ...
    *,
    ...
    min_duration = _number(thresholds.get("min_observation_seconds"), f"{prefix}_schema_invalid:min_observation_seconds")
    min_decisions = _integer(thresholds.get("min_decision_count"), f"{prefix}_schema_invalid:min_decision_count")
    min_closed = _integer(thresholds.get("min_closed_lifecycle_count"), f"{prefix}_schema_invalid:min_closed_lifecycle_count")
    max_blocked_ratio = _number(
        thresholds.get("max_blocked_decision_ratio"),
        f"{prefix}_schema_invalid:max_blocked_decision_ratio",
    )
    max_eq_breaches = _integer(
