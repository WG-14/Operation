...
RUN_LOG = logging.getLogger("operation.run")
...
def _notify_operator(message: str) -> None:
    importlib.import_module("operation.notifier").notify(message)
...
def _startup_controller() -> StartupController:
    ...
    return StartupController(
        ...
        initial_reconcile=lambda broker: importlib.import_module("operation.recovery").reconcile_with_broker(broker),
...
def _attempt_open_order_cancellation(broker: Broker, trigger: str) -> bool:
