...
from ..broker.availability import UnavailableBrokerFactory
from ..config import (
...
from ..marketdata_provider import NoopMarketDataProvider
...
def build_runtime_dependency_manifest(
    *,
    ...
    return RuntimeDependencyManifest(
        ...
        private_api_submit_boundary_identity="execution_service.ExecutionSubmitPlan.as_final_payload",
...
def create_default_runtime_app(settings_obj=settings) -> RuntimeAppContainer:
    ...
    market_data_provider = NoopMarketDataProvider()
    ...
    return RuntimeAppContainer(
        ...
        scheduler=scheduler,
        broker_factory=broker_factory,
        market_sync=lambda *, quiet=True, limit=200: market_data_provider.sync_candles(
            pair=settings_obj.PAIR,
