...
from operation.market_regime import MARKET_REGIME_VERSION, MarketRegimeSnapshot
from operation.market_regime.classifier import classify_sma_market_regime as _classify_sma_market_regime
