...
def _fee_gap(args: argparse.Namespace, _context) -> None:
    from operation.operator_commands import cmd_fee_gap_accounting_repair
...
def _fee_pending(args: argparse.Namespace, _context) -> None:
    from operation.operator_commands import cmd_fee_pending_accounting_repair
...
def _rebuild_position_authority(args: argparse.Namespace, _context) -> None:
    from operation.operator_commands import cmd_rebuild_position_authority
...
def _external_cash(args: argparse.Namespace, _context) -> None:
    from operation.operator_commands import cmd_record_external_cash_adjustment
...
def _manual_flat(args: argparse.Namespace, _context) -> None:
    from operation.operator_commands import cmd_manual_flat_accounting_repair
...
def _external_position(args: argparse.Namespace, _context) -> None:
    from operation.operator_commands import cmd_external_position_accounting_repair
