...
def _run(args: argparse.Namespace, _context) -> None:
    from operation.operator_commands import cmd_run
...
def _runtime_strategy_set_lint(_args: argparse.Namespace, context) -> int:
    from operation.config import LiveModeValidationError, validate_runtime_strategy_set_selection
    from operation.runtime_strategy_set import normalized_runtime_strategy_set_manifest
...
def _runtime_strategy_set_dump(args: argparse.Namespace, context) -> int:
    from operation.config import validate_runtime_strategy_set_selection
    from operation.runtime_strategy_set import normalized_runtime_strategy_set_manifest
