...
def _strategy_plugin_inventory(args: argparse.Namespace, context) -> int:
    del args
    from operation.strategy_plugin_inventory import strategy_plugin_inventory_json
...
def _strategy_plugin_validate(args: argparse.Namespace, context) -> int:
    from operation.strategy_plugin_inventory import strategy_target_verdict_json
...
def _strategy_sweep(args: argparse.Namespace, _context) -> None:
    ...
    from operation.operator_commands import cmd_strategy_sweep
...
def _build_strategy_sweep(parser: argparse.ArgumentParser) -> None:
    from operation.strategy_sweep import DEFAULT_STRATEGY_SWEEP_MAX_OPERATIONS
