...
def _inspect(args: argparse.Namespace, _context) -> int:
    from operation.operation_approval import OperationApprovalError, load_operation_approval
...
def _verify(args: argparse.Namespace, _context) -> int:
    from operation.config import settings
    from operation.operation_approval import runtime_contract_from_settings, verify_operation_approval_against_runtime
