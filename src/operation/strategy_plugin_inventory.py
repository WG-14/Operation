...
def _strategy_plugin_sources_by_name() -> dict[str, StrategyPluginSource]:
    ...
    from operation.operation_strategy.discovery import ENTRY_POINT_GROUP

    sources: dict[str, StrategyPluginSource] = {
        plugin.name: StrategyPluginSource(source="built_in_manifest", manifest_object_path="operation.operation_strategy.builtin:BUILTIN_OPERATION_STRATEGY_PLUGINS")
