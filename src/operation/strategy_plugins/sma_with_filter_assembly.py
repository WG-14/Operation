...
from operation.core.sma_policy import (
...
from operation.market_regime.policy import normalize_live_regime_policy
from operation.operation_strategy.spec import (
    exit_policy_hash,
...
if TYPE_CHECKING:
    from operation.strategy.exit_rules import ExitPolicyConfig
...
class SmaWithFilterPolicyAssembly:
    ...
    def build_strategy(
        ...
        *,
        ...
        from operation.strategy.sma_policy_strategy import create_sma_with_filter_strategy
    ...
    def build_execution_snapshot(
        ...
        *,
        ...
        from operation.canonical_decision import order_rules_snapshot_payload
...
def build_sma_with_filter_replay_fingerprint(
    *,
    ...
    from operation.decision_contract import DECISION_CONTRACT_VERSION
