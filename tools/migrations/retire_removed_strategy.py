...
from _offline_retirement import (
    SafetyCheckError, apply_plan, build_plan, canonical_json, load_plan, verify_backup, write_plan,
)
...
def main(argv: list[str] | None = None) -> int:
    try:
        ...
        if args.command == "plan":
            ...
            payload = {**json.loads(canonical_json(plan.__dict__)), "database_modified": False, "backup_created": False}
