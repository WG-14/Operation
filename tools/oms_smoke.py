...
from operation.broker.paper import paper_execute
from operation.config import PROJECT_ROOT, settings
...
def main() -> None:
    ...
    if row is None:
        raise SystemExit("No candles. Run `uv run operation sync` before this smoke check.")
